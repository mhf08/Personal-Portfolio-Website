    ...
    <section id="thesis" className="py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-8 max-w-7xl relative z-10">
        ...
        >
          ...
          <div className="text-xl text-muted-foreground font-light border-l-2 border-primary pl-6 py-2 max-w-3xl">
            <TextReveal>
          ...
          >
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground font-light pl-9 list-disc">
                <li><TextReveal>Machine Learning: XGBoost and LightGBM</TextReveal></li>
                <li><TextReveal>Deep Learning: Temporal Fusion Transformers (TFT) for capturing complex temporal dependencies</TextReveal></li>
                <li><TextReveal>Performance: ML models achieved superior Fill Rates and significantly lower Bullwhip Ratios compared to traditional and history-based heuristics, especially during "Geo On" (Geopolitical Disruption) scenarios.</TextReveal></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground font-light pl-9 list-disc">
                <li><TextReveal>None (Control): Traditional siloed visibility</TextReveal></li>
                <li><TextReveal>Pipeline Visibility: Shared tracking of transit inventory</TextReveal></li>
                <li><TextReveal>Full Visibility: Complete transparency of demand signals and inventory positions across all actors</TextReveal></li>
                <li><TextReveal>Impact: Full Blockchain visibility consistently reduced the Bullwhip Ratio at Actor 2, stabilizing orders even when lead times followed a high-variance Gamma Distribution.</TextReveal></li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-8">
              <div className="relative pl-6 border-l border-primary/30">
                ...
                <TextReveal className="text-muted-foreground font-light text-sm leading-relaxed">
